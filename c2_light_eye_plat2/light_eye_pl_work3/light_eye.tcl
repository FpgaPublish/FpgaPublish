...
## Revision 0.02 - Get the complex path to adjust the project
## Additional Comments:
## 
##################################################################################
...
#add cores
set prj_cores_path $prj_path
append prj_cores_path "/"
append prj_cores_path $prj_name
append prj_cores_path ".core"
file mkdir $prj_cores_path
