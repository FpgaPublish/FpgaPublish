...
HD_PWD='D:/e1_library/e1_key_led_plat2/key_led_pl_core2/key_led_v2_22.cores/key_led_v2_13.cores/key_led_v2_13_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_led_blck.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_led_blck.tcl
